...
if __name__ == '__main__':
    ...
    import time, os
    from utils import AverageMeter, compute_batch_accuracy
    ...
    def validate(val_loader, model, *args):
        ...
        with torch.no_grad():
            ...
            for inputs, labels in val_loader:
                ...
                acc1, acc5 = compute_batch_accuracy(outputs, labels, topk=(1, 5))
    ...
    # 数据集存放路径
    data_dir = r'D:\datasets\imagenet-mini'
    ...
    renet18 = resnet18()
    pt = torch.load(r"D:\installpackages\resnet18-5c106cde.pth", map_location=torch.device('cpu'))
    # print(pt)
    renet18.load_state_dict(pt)

    top1_avg, top5_avg, throughput = validate(dataloaders['val'], renet18)
    print(f"Top1: {top1_avg}, Top5: {top5_avg}, throughput: {throughput}")
